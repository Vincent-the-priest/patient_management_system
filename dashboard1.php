...
<div class="dashboard-container">
        ...
        <nav>
               ...
               <button id="add user"><a href="patient.php">Patient </a></button> 
        ...
        <aside>
            ...
            <ul>
                ...
                <li><button><a href="dashboard4.php">Registed User</a></button></li>
...
if (!empty($data)) {
    echo "<table border='1'>";
    echo "<tr><th>Patient ID</th><th>Last_Name</th><th>Last_Name</th><th>Last_Name</th><th>Gender</th><th>Review</th></tr>";
